    ...
    <div className=" mt-3 flex h-full w-full select-none  flex-col justify-between px-6">
      <div className="flex justify-between self-center">
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-2 text-center text-primary">Finalize Deck</p>
        </div>
      </div>
      <div className=" mt-8 flex  flex-col justify-between self-center">
        <div className="flex flex-col ">
          <label className="text-sm text-text-gray-2">Deck Name</label>
          <input
      ...
      <button
        ...
        class="  mb-7 mt-8 flex w-[250px] select-none items-center justify-center  self-center rounded-[10px]  bg-primary px-4 py-4 text-lg font-semibold text-white sm:w-[335px] "
      >
        Start
      </button>
    </div>
