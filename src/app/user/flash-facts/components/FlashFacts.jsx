...
export default function FlashFacts({ disciplines, token ,revalidateData }) {
  ...
  return (
    <div className="select-none bg-light-gray px-3 pt-6 sm:px-6 md:px-8">
      <AnimatePresence>{isOpen && <AddDeck toggle={toggle} disciplines={disciplines} token={token}/>}</AnimatePresence>
