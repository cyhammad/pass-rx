        ...
        <table className="mt-5 w-full min-w-fit table-auto">
          <thead className="bg-table-header">
            <tr className="text-text-gray-2">
              <th className="min-w-[250px] rounded-s-md py-3 pl-6 text-start font-semibold">
                Name
              </th>
              <th className="min-w-[250px] py-3 text-start font-semibold">
                Total Flash Cards
              </th>
              <th className="min-w-[250px] py-3 text-start font-semibold">
                Date Created
              </th>
              <th className="min-w-[150px] rounded-e-md py-3 text-start font-semibold">
                Status
              </th>
