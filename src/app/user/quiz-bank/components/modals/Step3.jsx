  ...
  return (
    <div className=" mt-3 flex h-full w-full flex-col  select-none justify-between px-6">
      ...
      <button
        ...
        class="  mb-7 select-none mt-8 flex w-[250px] items-center justify-center  self-center rounded-[10px]  bg-primary px-4 py-4 text-lg font-semibold text-white sm:w-[335px] "
      >
        Start
      </button>
    </div>
