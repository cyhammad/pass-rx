...
export default function Bricks() {
  ...
  return (
    <div className="flex w-full flex-col">
      ...
      <div className=" mt-8 flex w-[95%]   items-center justify-center gap-x-2 self-center rounded-lg border border-border-color px-4 py-3 shadow-[0px_2px_12px_0px_#C9C9C938] sm:w-[372px]">
        ...
        <input
          ...
          id="search"
          placeholder="Search"
          className="w-full bg-light-gray outline-none sm:w-[372px]"
        />
      </div>
      ...
      <div className="mt-8 grid grid-cols-1 justify-items-center gap-x-[18px] gap-y-28 px-3   sm:gap-y-28 sm:px-14 md:grid-cols-2  lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
        {cardData.map((number) => (
          <div key={number}>
            <Card />
          </div>
