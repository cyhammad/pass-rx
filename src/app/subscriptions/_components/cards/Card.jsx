...
export default function Card() {
  ...
  return (
    <div className="h-[325px]   max-w-[330px] rounded-2xl  bg-white p-6 shadow sm:p-9 md:h-[395px]">
      <span>{star}</span>
      ...
      <input
        ...
        id="text"
        placeholder="$110"
        className={`mt-5 h-[72px] w-full bg-transparent text-5xl font-bold outline-none placeholder:text-black md:mt-11 ${editable ? "" : "pointer-events-none"}`}
        value={text}
      ...
      {editable ? (
        <button
          className="mt-2 w-full rounded-lg border border-primary bg-primary px-1 py-2 font-semibold text-white focus:outline-none md:py-4 md:text-[18px]"
          onClick={handleSave}
        >
          Save
        </button>
        ...
        <button
          className="mt-2 w-full rounded-lg border border-primary px-1 py-2 font-semibold text-primary focus:outline-none md:py-4 md:text-[18px]"
