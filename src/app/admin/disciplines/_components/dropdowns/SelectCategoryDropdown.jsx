  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      <button
        ...
        className="flex h-[54px] w-full items-center rounded-lg border border-border-color px-3 text-start sm:min-w-[250px]"
      >
        {selectedCategory ? (
          <span className="w-full text-sm">{selectedCategory.name}</span>
        ) : (
          <span className="w-full text-sm text-[#6B7280]">Select Category</span>
        )}
