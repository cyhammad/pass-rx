import { addCategory } from "@/app/lib/actions/categoryActions";
import { revalidateData } from "@/app/utils/revalidate-data";
import { motion } from "framer-motion";
import { useState } from "react";

export default function AddCategoryModal({ toggleModal, token }) {
  ...
  const handleCreateCategory = async () => {
    ...
    const res = await addCategory(token, categoryName);
  ...
  //   on pressing enter key invoke addCategory function
