...
const QuestionDropdown = ({ question, token, quizbank }) => {
  ...
  const handleEditClick = () => {
    setIsEditModalOpen(true); // Step 3: Set isEditModalOpen to true on edit button click
    toggleMenu();
  };
  return (
    <>
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 top-6 flex w-40 flex-col justify-between rounded-xl border border-blackBorder bg-dark text-white"
          >
