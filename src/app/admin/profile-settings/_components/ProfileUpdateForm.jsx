  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row">
        <div className="flex flex-col gap-y-6 px-4 py-5 sm:w-2/3">
          <div className="flex flex-col gap-y-3">
            <label htmlFor="username" className="text-sm font-medium">
              Name
            </label>
            <input
              className="h-[54px] w-full rounded-md px-4 py-2 text-sm"
              type="text"
              id="username"
              name="username"
              placeholder="Jane"
      ...
      <div className="flex gap-x-3 py-10">
        <button
          className="h-[60px] w-full rounded-md px-4 py-2 text-sm"
          type="reset"
        >
          Discard Changes
        </button>
