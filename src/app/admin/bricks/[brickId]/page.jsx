...
export default function page() {
  ...
  return (
    <div className="flex w-full flex-col ">
        ...
        <div className="xl:flex-nowrap flex-wrap">
          <div className="flex xl:flex-nowrap flex-wrap ">
            <input
              ...
              id="text"
              placeholder="$110"
              className={` -mt-2.5 max-w-72 bg-transparent md:text-[40px] text-3xl font-semibold outline-none placeholder:text-black  ${editable ? "border-b border-black/20 text-text-gray" : "pointer-events-none"}`}
              value={text}
      ...
      <div className=" mt-6 flex flex-col justify-between gap-x-[4rem] lg:flex-row lg:pr-11 xl:ml-[10rem]">
        <Topics />
        <LearningObjectives />
      </div>
    </div>
