      ...
      <div className="relative z-20 w-full" ref={dropdownRef}>
        ...
        >
          <span className="flex w-full items-center justify-between gap-3 rounded-[100px] px-3 py-[5px]  text-sm text-dark">
            <div className="flex items-center justify-between gap-1">
              {" "}
              Fundamentals of Statistics {add}
            </div>
        ...
        {isOpen && (
          <motion.div
            ...
            className=" right-0 top-7 flex w-full flex-col justify-between rounded-xl  pb-2.5 text-text-gray"
          >
            <div className="z-50 flex  w-full flex-col gap-y-1.5 py-2">
              <button className="flex  w-full items-center justify-between px-3 py-1.5">
