    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <motion.div
          ...
          className="absolute right-0 top-7 flex w-40 z-40 flex-col justify-between rounded-xl bg-dark pb-2.5 text-white"
        >
          <div className="flex flex-col gap-y-1.5 py-2">
            <button className="flex items-center justify-between px-4 py-1.5" onClick={() => handleOptionClick("Discipline1")}>
